...
date: '2020-05-04'
slug: experiment-10-create-a-rectangular-boundary-that-encloses-the-outline
categories:
    - Computer Vision
tags:
    - Computer Vision
...
![Create a rectangular boundary that encloses the outline 1](images/image01.png)

![Create a rectangular boundary that encloses the outline 2](images/image02.png)

![Create a rectangular boundary that encloses the outline 3](images/image03.png)

![Create a rectangular boundary that encloses the outline 4](images/image04.png)
