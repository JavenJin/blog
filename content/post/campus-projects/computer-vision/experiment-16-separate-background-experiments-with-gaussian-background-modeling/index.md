...
![Separate background experiments with Gaussian background modeling 1](images/image01.png)

![Separate background experiments with Gaussian background modeling 2](images/image02.png)

![Separate background experiments with Gaussian background modeling 3](images/image03.png)

![Separate background experiments with Gaussian background modeling 4](images/image04.png)

![Separate background experiments with Gaussian background modeling 5](images/image05.png)
