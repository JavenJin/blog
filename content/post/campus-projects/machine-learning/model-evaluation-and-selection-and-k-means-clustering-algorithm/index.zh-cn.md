...
date: '2020-11-11'
slug: model-evaluation-and-selection-and-k-means-clustering-algorithm
aliases:
    - /zh-cn/p/model-evaluation-and-selection-k-means-clustering-algorithm/
categories:
    - Machine Learning
tags:
    - Machine Learning
...
```
### K-means聚类的sklearn实现：
![sklearn implementation of k-means clustering](images/image01.png)
